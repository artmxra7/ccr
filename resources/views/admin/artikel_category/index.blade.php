            ...
            <div class="m-portlet__head">
                {{-- <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        <a href="{!! route('admin.artikel-kategori.create') !!}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            <span>
    ...
    <script>
            $(document).ready(function(){
               ...
               $('#table_data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:'{{ route('admin.datatable_newscat') }}',
                    },
                    columnDefs: [
                            {
                               targets: 0 ,
                    ...
                    columns: [
                      {data: 'id', name: 'id'},
                      {data: 'artikels_category_name', name: 'name'},
                      {data: 'aksi', name: 'aksi'}
                    ]
              });
            })
