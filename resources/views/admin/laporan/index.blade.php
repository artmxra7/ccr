                ...
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{ url('admin/laporan') }}" class="m-nav__link">
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        <a href="{!! route('admin.laporan.create') !!}" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            <span>
    ...
    <script>
            $(document).ready(function(){
               ...
               $('#table_data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:'{{ route('admin.datatable_laporan') }}',
                    },
                    columnDefs: [
                            {
                               targets: 0 ,
