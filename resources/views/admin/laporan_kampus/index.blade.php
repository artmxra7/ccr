    ...
    <div class="m-content">
        ...
        <div class="m-subheader" style="padding:0px;margin-bottom:20px;">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title m-subheader__title--separator">Laporan Kampus</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{ url('admin/laporan-kampus') }}" class="m-nav__link">
                                <span class="m-nav__link-text">Laporan Kampus</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <script>
            $(document).ready(function(){
               ...
               $('#table_data').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url:'{{ route('admin.datatable_laporan_kampus') }}',
                    },
                    columnDefs: [
                            {
                               targets: 0 ,
